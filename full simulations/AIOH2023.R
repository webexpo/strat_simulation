...
##### simulation 1 ##### 
    ...
    rel_bias_ideal_gm <- 100*mean( (simulation_summary$ideal_gm - true_gm)/true_gm)
    rel_bias_naive_gm <- 100*mean( (simulation_summary$naive_gm - true_gm)/true_gm)
    rel_bias_me_gm <- 100*mean( (simulation_summary$me_gm - true_gm)/true_gm)
    rel_bias_gum_gm <- 100*mean( (simulation_summary$gum_gm - true_gm)/true_gm)
    ...
    rel_bias_ideal_gsd <- 100*mean( (simulation_summary$ideal_gsd - true_gsd)/true_gsd)
    rel_bias_naive_gsd <- 100*mean( (simulation_summary$naive_gsd - true_gsd)/true_gsd)
    rel_bias_me_gsd <- 100*mean( (simulation_summary$me_gsd - true_gsd)/true_gsd)
    rel_bias_gum_gsd <- 100*mean( (simulation_summary$gum_gsd - true_gsd)/true_gsd)
    ...
    rel_bias_ideal_p95 <- 100*mean( (simulation_summary$ideal_p95 - true_p95)/true_p95)
    rel_bias_naive_p95 <- 100*mean( (simulation_summary$naive_p95 - true_p95)/true_p95)
    rel_bias_me_p95 <- 100*mean( (simulation_summary$me_p95 - true_p95)/true_p95)
    rel_bias_gum_p95 <- 100*mean( (simulation_summary$gum_p95 - true_p95)/true_p95)
    ...
    ## distance P95 to P95UCL
    
    median( simulation_summary$ideal_p95_ucl / simulation_summary$ideal_p95)
    median( simulation_summary$naive_p95_ucl / simulation_summary$naive_p95)
    median( simulation_summary$me_p95_ucl / simulation_summary$me_p95)
    median( simulation_summary$gum_p95_ucl / simulation_summary$gum_p95)
    
    
    ## coverage
    
    100*sum(simulation_summary$ideal_p95_ucl>=true_p95)/length(simulation_summary$ideal_p95_ucl)
    100*sum(simulation_summary$naive_p95_ucl>=true_p95)/length(simulation_summary$ideal_p95_ucl)
    100*sum(simulation_summary$me_p95_ucl>=true_p95)/length(simulation_summary$ideal_p95_ucl)
    100*sum(simulation_summary$gum_p95_ucl>=true_p95)/length(simulation_summary$ideal_p95_ucl)
...
##### simulation 2 ##### 
    ...
    saveRDS( simulation_summary, "created data/aioh2023-r2.RDS")
