...
##### Functions #####
    ...
    my.parallel.function <- function( index ) {
      ...
      ideal_analysis_freq <- myfunction.freq( true_data , oel)
      
      naive_analysis_freq <- myfunction.freq( observed_data , oel)
...
#### Analysis #####
  ...
  ###### simulation 1 ##### 
    ...
    saveRDS( simulation_summary, "created data/aioh2023-S2_1.RDS")
...
###### simulation 2 ###### 
    ...
    saveRDS( simulation_summary, "created data/aioh2023-S2_2.RDS")    
