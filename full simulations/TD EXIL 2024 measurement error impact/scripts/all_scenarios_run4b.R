...
# run 4 : measurement error with a CV of 0.125
...
for (i in 1:dim(scenarios)[1]) {
  ...
  simulation_results[[i]] <- parallel.function( simulated_data_object = simulated_data_objects[[i]] , me_cv = me_cv , 
                                                ...
                                                n_clusters = 12, oel = rep(scenarios$oel[i],n_sim))
...
saveRDS(simulation_results, file = "C:/jerome/Dropbox/GITHUB/WEBEXPO/sampling_strats/EXIL TD 2024/all_scenarios_run4b_sim.RDS")

saveRDS(simulated_data_objects, file = "C:/jerome/Dropbox/GITHUB/WEBEXPO/sampling_strats/EXIL TD 2024/all_scenarios_run4b_data.RDS")
