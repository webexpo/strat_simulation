...
# Real GSD results for Sarah Exil's study

# 600 hours for me.sd=0.125
# 750 hours for me.sd=0.25
...
me0.125 <- readRDS( file = paste( init_path ,"GITHUB/WEBEXPO/sampling_strats/EXIL TD 2024/aggregated results/cv0.125_realgsd.RDS", sep="") )    

# results for me.cv=0.25
me0.25 <- readRDS( file = paste( init_path ,"GITHUB/WEBEXPO/sampling_strats/EXIL TD 2024/aggregated results/cv0.25_realgsd.RDS", sep="") )    
...
main_dataset <- main_dataset[,c(1:4,20:23,5:19) ]

# creating a variable description table

dictionnary <- data.frame( variable = names(main_dataset) , description = c("True exceedance fraction in %",
                                                                            "Sample size",
                                                                            "Proportion of censored values",
...
write_xlsx( main_dataset , path = paste( init_path ,"GITHUB/WEBEXPO/sampling_strats/EXIL TD 2024/aggregated results/realGSD_analysis.xlsx", sep="") )

write_xlsx( dictionnary , path = paste( init_path ,"GITHUB/WEBEXPO/sampling_strats/EXIL TD 2024/aggregated results/realGSD_analysis_dictionnary.xlsx", sep="")  )
